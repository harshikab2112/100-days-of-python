...
first_choice = input("You're at a crossroad. Where do you want to go? (left/right): ").lower()

if first_choice == "left":
    second_choice = input("You arrive at a lake. There is an island in the middle.\nType 'wait' to wait for a boat or 'swim' to swim across: ").lower()
